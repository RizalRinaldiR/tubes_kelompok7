            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="GET" action="{{ route('owner.products.index') }}">
                        <div class="mb-4">
                            <select id="branch_id" name="branch_id" class="inline w-2/12 pt-2.5 pb-2.5 text-black rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <x-table>
                        ...
                        @foreach ($products as $product)
                            <tr>
                                ...
                                <td class="text-center">{{ $product->branch->name }}</td>
                            </tr>
                        @endforeach
                    </x-table>  
                @else
                    <p class="text-gray-600 dark:text-gray-400">Silahkan pilih branch Untuk Melihat Data Product.</p>
                @endif
